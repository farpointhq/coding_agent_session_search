...
const CONTRACTS: &[DependencyContract] = &[
    ...
    DependencyContract {
        ...
        expected_git: "https://github.com/farpointhq/franken_agent_detection",
        expected_rev: "26316d689fc7a1316edfa4306c36c2db960f8633",
        expected_version: "0.1.4",
        expected_features: &["chatgpt", "connectors", "crush", "cursor", "opencode"],
        expected_default_features: None,
        repo_rel: "../franken_agent_detection",
        manifest_rel: "Cargo.toml",
        patch_url: Some("https://github.com/farpointhq/franken_agent_detection"),
